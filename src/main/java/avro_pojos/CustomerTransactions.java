...
public class CustomerTransactions extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    @Deprecated
    public java.lang.String return_surrogate_key;
    @Deprecated
    public java.lang.String return_reference_number;
    /** bi_id */
    @Deprecated
    public java.lang.Long usa_id;
    /** sephora_id field */
    @Deprecated
    public java.lang.Long sephora_id;
    /** online_atg_id field */
    @Deprecated
    public java.lang.String online_atg_id;
    /** card_number token from order_tender_details_events table */
    @Deprecated
    public java.lang.String card_number;
    /** return_auth_flag field */
    @Deprecated
    public java.lang.String return_auth_flag;
    /** the reason why the current return has such return_auth_flag */
    @Deprecated
    public java.lang.String reason_text;
    /** cust_sale_counter field */
    @Deprecated
    public int cust_sale_counter;
    /** cust_return_counter field */
    @Deprecated
    public int cust_return_counter;
    /** pct_sale_to_return field */
    @Deprecated
    public double pct_sale_to_return;
    /** created_date field */
    @Deprecated
    ...
    @Deprecated
    public java.lang.String active_flag;
    @Deprecated
    public java.util.List<OrderHeaderTender> orders;
    @Deprecated
    public java.util.List<Rule> rules;
    /** record_update_flag field U or D */
    @Deprecated
    public java.lang.String record_update_flag;
    /**
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            case 0:
                return_surrogate_key = value$ != null ? value$.toString() : null;
                break;
            case 1:
                return_reference_number = value$ != null ? value$.toString() : null;
                break;
            case 2:
                usa_id = (java.lang.Long) value$;
                break;
            case 3:
                sephora_id = (java.lang.Long) value$;
                break;
            case 4:
                online_atg_id = value$ != null ? value$.toString() : null;
                break;
            case 5:
                card_number = value$ != null ? value$.toString() : null;
                break;
            case 6:
                return_auth_flag = value$ != null ? value$.toString() : null;
                break;
            case 7:
                reason_text = value$ != null ? value$.toString() : null;
                break;
            case 8:
                cust_sale_counter = (java.lang.Integer) value$;
                break;
            case 9:
                cust_return_counter = (java.lang.Integer) value$;
                break;
            case 10:
                pct_sale_to_return = (java.lang.Double) value$;
                break;
            case 11:
                created_date = (java.lang.Long) value$;
                break;
            case 12:
                start_date = (java.lang.Long) value$;
                break;
            case 13:
                end_date = (java.lang.Long) value$;
                break;
            case 14:
                active_flag = value$ != null ? value$.toString() : null;
                break;
            case 15:
                orders = (java.util.List<OrderHeaderTender>) value$;
                break;
            case 16:
                rules = (java.util.List<Rule>) value$;
                break;
            case 17:
                record_update_flag = value$ != null ? value$.toString() : null;
                break;
            default:
                throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
