...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public reach_file_formats.avro.ClientIdentifier clientIdentifier;
  @Deprecated public java.util.List<java.lang.CharSequence> employeeNames;
  @Deprecated public reach_file_formats.avro.Active active;
   ...
   */
  public AvroHttpRequest(java.lang.Long requestTime, reach_file_formats.avro.ClientIdentifier clientIdentifier, java.util.List<java.lang.CharSequence> employeeNames, reach_file_formats.avro.Active active) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: clientIdentifier = (reach_file_formats.avro.ClientIdentifier)value$; break;
    case 2: employeeNames = (java.util.List<java.lang.CharSequence>)value$; break;
    case 3: active = (reach_file_formats.avro.Active)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public reach_file_formats.avro.ClientIdentifier getClientIdentifier() {
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(reach_file_formats.avro.ClientIdentifier value) {
   ...
   */
  public reach_file_formats.avro.Active getActive() {
    return active;
  }
   ...
   * @param value the value to set.
   */
  public void setActive(reach_file_formats.avro.Active value) {
    this.active = value;
  }
   ...
   */
  public static reach_file_formats.avro.AvroHttpRequest.Builder newBuilder() {
    return new reach_file_formats.avro.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static reach_file_formats.avro.AvroHttpRequest.Builder newBuilder(reach_file_formats.avro.AvroHttpRequest.Builder other) {
    return new reach_file_formats.avro.AvroHttpRequest.Builder(other);
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static reach_file_formats.avro.AvroHttpRequest.Builder newBuilder(reach_file_formats.avro.AvroHttpRequest other) {
    return new reach_file_formats.avro.AvroHttpRequest.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
    ...
    private reach_file_formats.avro.ClientIdentifier clientIdentifier;
    private reach_file_formats.avro.ClientIdentifier.Builder clientIdentifierBuilder;
    private java.util.List<java.lang.CharSequence> employeeNames;
    private reach_file_formats.avro.Active active;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(reach_file_formats.avro.AvroHttpRequest.Builder other) {
      super(other);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = reach_file_formats.avro.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(reach_file_formats.avro.AvroHttpRequest other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTime)) {
        this.requestTime = data().deepCopy(fields()[0].schema(), other.requestTime);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public reach_file_formats.avro.AvroHttpRequest.Builder setRequestTime(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public reach_file_formats.avro.AvroHttpRequest.Builder clearRequestTime() {
    ...
    /**
      ...
      * @return This builder.
      */
    public reach_file_formats.avro.AvroHttpRequest.Builder setClientIdentifier(reach_file_formats.avro.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public reach_file_formats.avro.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(reach_file_formats.avro.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(reach_file_formats.avro.ClientIdentifier.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public reach_file_formats.avro.AvroHttpRequest.Builder setClientIdentifierBuilder(reach_file_formats.avro.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public reach_file_formats.avro.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public reach_file_formats.avro.AvroHttpRequest.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public reach_file_formats.avro.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public reach_file_formats.avro.AvroHttpRequest.Builder setActive(reach_file_formats.avro.Active value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public reach_file_formats.avro.AvroHttpRequest.Builder clearActive() {
      active = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        if (clientIdentifierBuilder != null) {
          ...
          record.clientIdentifier = fieldSetFlags()[1] ? this.clientIdentifier : (reach_file_formats.avro.ClientIdentifier) defaultValue(fields()[1]);
        }
        record.employeeNames = fieldSetFlags()[2] ? this.employeeNames : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[2]);
        record.active = fieldSetFlags()[3] ? this.active : (reach_file_formats.avro.Active) defaultValue(fields()[3]);
        return record;
