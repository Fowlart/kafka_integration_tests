...
public class ClientIdentifier extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3710086580145019962L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ClientIdentifier\",\"namespace\":\"reach_file_formats.avro\",\"fields\":[{\"name\":\"hostName\",\"type\":\"string\"},{\"name\":\"ipAddress\",\"type\":\"string\"}]}");
   ...
   */
  public static reach_file_formats.avro.ClientIdentifier.Builder newBuilder() {
    return new reach_file_formats.avro.ClientIdentifier.Builder();
  }
   ...
   * @return A new ClientIdentifier RecordBuilder
   */
  public static reach_file_formats.avro.ClientIdentifier.Builder newBuilder(reach_file_formats.avro.ClientIdentifier.Builder other) {
    return new reach_file_formats.avro.ClientIdentifier.Builder(other);
  }
   ...
   * @return A new ClientIdentifier RecordBuilder
   */
  public static reach_file_formats.avro.ClientIdentifier.Builder newBuilder(reach_file_formats.avro.ClientIdentifier other) {
    return new reach_file_formats.avro.ClientIdentifier.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ClientIdentifier>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(reach_file_formats.avro.ClientIdentifier.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(reach_file_formats.avro.ClientIdentifier other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.hostName)) {
        this.hostName = data().deepCopy(fields()[0].schema(), other.hostName);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public reach_file_formats.avro.ClientIdentifier.Builder setHostName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public reach_file_formats.avro.ClientIdentifier.Builder clearHostName() {
      hostName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public reach_file_formats.avro.ClientIdentifier.Builder setIpAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public reach_file_formats.avro.ClientIdentifier.Builder clearIpAddress() {
      ipAddress = null;
