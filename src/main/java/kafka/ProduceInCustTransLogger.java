...
public class ProduceInCustTransLogger {
    ...
    public static <K, V> void produceRecord(K key, V record, String topic, int times) {
        ...
        KafkaProducer<K, V> producer = new KafkaProducer<>(getProperties("/Users/artur/IdeaProjects/tests_experiments_preparations_examples/src/main/resources/dev-kafka.properties"));
